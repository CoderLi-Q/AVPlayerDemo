...
- (void)viewDidLoad {
    ...
    NSURL *url = [NSURL URLWithString:@"http://asp.cntv.lxdns.com/asp/hls/main/0303000a/3/default/364df9c2d319479e8bcf0a5628bd254e/main.m3u8?maxbr=2048"];
    self.url = url;
    ...
    //显示GIF图的按钮
    UIButton *view= [[UIButton alloc]initWithFrame:CGRectMake(0, 600, 100, 100)];
...
#pragma mark --- 创建UI
- (void)createUI{
    CGRect rect = CGRectMake(0, 460, self.view.frame.size.width, 6);
